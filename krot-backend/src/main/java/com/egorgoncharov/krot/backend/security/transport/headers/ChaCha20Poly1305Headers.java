package com.egorgoncharov.krot.backend.security.transport.headers;
...
@AllArgsConstructor
@NoArgsConstructor
public class ChaCha20Poly1305Headers {
    ...
    public static ChaCha20Poly1305Headers fromRoutingContext(RoutingContext context) {
        return new ChaCha20Poly1305Headers(context.request().getHeader(TAG_HEADER_NAME), context.request().getHeader(NONCE_HEADER_NAME));
    }
    ...
    public boolean equals(Object o) {
        if (!(o instanceof ChaCha20Poly1305Headers that)) return false;
