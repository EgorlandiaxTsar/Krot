...
@ApplicationScoped
public class UserService extends AbstractModificationService<UserEntity, UUID, Void> {
    ...
    @WithTransaction
    @Override
    public Uni<Result<UserEntity>> create(CreationContext<UserEntity, UUID, Void> context) {
    ...
    @WithTransaction
    @Override
    public Uni<Result<UserEntity>> update(UpdateContext<UserEntity, UUID, Void> context) {
    ...
    @WithTransaction
    @Override
    public Uni<Result<List<UserEntity>>> delete(DeleteContext<UserEntity, UUID, Void> context) {
    ...
    @WithTransaction
    public Uni<Result<Void>> updatePassword(UpdateContext<UserEntity, UUID, Void> context) {
