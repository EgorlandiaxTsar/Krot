...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    @Inject
    public AuthenticationServiceImpl(CurrentIdentityAssociation currentIdentityAssociation, SecurityIdentity client, SessionConfig sessionConfig, HistoricalSessionServiceImpl historicalSessionService, SessionRepository sessionRepository, HistoricalSessionRepository historicalSessionRepository, UserRepository userRepository, DeviceRepository deviceRepository) {
