package com.egorgoncharov.krot.backend.database.relational;

import com.egorgoncharov.krot.backend.database.CrudRepository;
...
public interface RelationalCrudRepository<T extends Identifiable<I>, I> extends CrudRepository<T, I>, PanacheRepositoryBase<T, I> {
