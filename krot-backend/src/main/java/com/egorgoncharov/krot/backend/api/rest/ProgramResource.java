...
import com.egorgoncharov.krot.backend.api.model.request.TransferOwnershipRequest;
import com.egorgoncharov.krot.backend.api.model.request.program.DeleteProgramCollaboratorRequest;
import com.egorgoncharov.krot.backend.api.model.request.program.GetProgramRequest;
import com.egorgoncharov.krot.backend.api.model.request.program.UpsertProgramCollaboratorRequest;
import com.egorgoncharov.krot.backend.api.model.request.program.UpsertProgramRequest;
...
import com.egorgoncharov.krot.backend.application.domain.ProgramDomain;
...
public class ProgramResource {
    ...
    public Uni<RestResponse<ApiResponse<Void>>> deleteProgramCollaborator(@Valid DeleteProgramCollaboratorRequest body) {
        return programDomain.deleteCollaborator(ProgramEntity.builder()
                .id(Types.toUUID(body.getProgramId()))
