...
@ApplicationScoped
public class ProgramService extends AbstractModifyingService<ProgramEntity, UUID, Void> {
    ...
    @WithTransaction
    @Override
    public Uni<Result<ProgramEntity>> create(EntityCreationContext<ProgramEntity, UUID, Void> context) {
    ...
    @WithTransaction
    @Override
    public Uni<Result<ProgramEntity>> update(EntityUpdateContext<ProgramEntity, UUID, Void> context) {
    ...
    @WithTransaction
    @Override
    public Uni<Result<List<ProgramEntity>>> delete(EntityDeleteContext<ProgramEntity, UUID, Void> context) {
    ...
    @WithTransaction
    public Uni<Result<Void>> upsertCollaborator(EntityUpdateContext<ProgramEntity, UUID, Void> context) {
    ...
    @WithTransaction
    public Uni<Result<Void>> deleteCollaborator(EntityUpdateContext<ProgramEntity, UUID, Void> context) {
        ProgramCollaboratorEntity collaborator = context.getNewEntity().getCollaborators().getFirst();
        return collaboratorRepository.removeById(collaborator.getId()).chain(() -> Result.ok().voidCast().toUni());
    }

    @WithTransaction
    public Uni<Result<Void>> transferOwnership(EntityUpdateContext<ProgramEntity, UUID, Void> context) {
