package com.egorgoncharov.krot.backend.application;

import com.egorgoncharov.krot.backend.api.rest.response.ApiResponse;
import com.egorgoncharov.krot.backend.api.rest.response.ApiResponseMetadata;
import com.egorgoncharov.krot.backend.util.Messages;
...
public class Result<T> {
    ...
    public static <T> Result<T> ok(T result) {
        return Result.from(result, Messages.msgOk(), 200);
    }
    ...
    public static <T> Result<T> badRequest() {
        return Result.from(null, Messages.msgBadRequest(), 400);
    }
    ...
    public static <T> Result<T> notFound() {
        return Result.from(null, Messages.msgNotFound(), 404);
    }

    public static <T> Result<T> unauthorized() {
        return Result.from(null, Messages.msgUnauthorized(), 401);
    }

    public static <T> Result<T> forbidden() {
        return Result.from(null, Messages.msgForbidden(), 403);
    }

    public static <T> Result<T> conflict() {
        return Result.from(null, Messages.msgConflict(), 409);
    }
    ...
    public static <T> Result<T> error() {
        return Result.from(null, Messages.msgInternalError(), 500);
    }
