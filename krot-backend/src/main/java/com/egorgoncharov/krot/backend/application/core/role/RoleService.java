...
@ApplicationScoped
public class RoleService extends AbstractModifyingService<RoleEntity, UUID, Void> {
    ...
    @WithTransaction
    @Override
    public Uni<Result<RoleEntity>> create(EntityCreationContext<RoleEntity, UUID, Void> context) {
    ...
    @WithTransaction
    @Override
    public Uni<Result<RoleEntity>> update(EntityUpdateContext<RoleEntity, UUID, Void> context) {
    ...
    @WithTransaction
    @Override
    public Uni<Result<List<RoleEntity>>> delete(EntityDeleteContext<RoleEntity, UUID, Void> context) {
